...
export const Profile =({src,position,name,email}:IProfile)=>{
  return(
    <div className="flex flex-col">
      ...
      <div className="relative m-auto stop-[-380px] lg:left-[12px] lg:bottom-[340px] rounded-2xl h-[352px] w-[268px] bg-main_green border border-border_green mb-10 lg:mb-0 lg:m-0">
        <p>bonjour</p>
      </div>
    </div>
  )
